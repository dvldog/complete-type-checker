...
abstract class Parser extends Lexical_Analyzer{
	...
	public static HashMap<String,String> funType = new HashMap<String,String>();// Hash Map of the function name and type
	public static HashMap<String,String> parameterVarType = new HashMap<String,String>();// Hash Map of the parameter name and type
	public static HashMap<String,Integer> variablePos = new HashMap<String,Integer>();// Hash Map of the name and variable position
	public static HashMap<String,Integer> funTypeVariables = new HashMap<String,Integer>();// Hash Map of the function name and total number of variables it contains
